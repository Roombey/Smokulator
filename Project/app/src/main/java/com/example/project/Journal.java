...
public class Journal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i = 0;
        Cursor cursord = mDb.rawQuery("SELECT Name, Time FROM diary Where Date = '" + today + "'", null);
        Cursor cursort = mDb.rawQuery("SELECT Time FROM diary Where Date = '" + today + "'", null);
        Cursor cursoro = mDb.rawQuery("SELECT Own FROM diary Where Date = '" + today + "'", null);
        cursord.moveToFirst();
        cursort.moveToFirst();
        cursoro.moveToFirst();
